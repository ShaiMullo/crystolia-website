    ...
    >
      ...
      >
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl font-light text-gray-600 animate-fade-in-delay">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="btn-animate w-full px-8 py-4 bg-[#F5C542] text-white rounded-full font-light text-base tracking-wide hover:bg-[#F5C542]/90 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {status === "sending"
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <button
              ...
              className="btn-animate w-full px-8 py-4 bg-[#25D366] text-white rounded-full font-light text-base tracking-wide hover:bg-[#25D366]/90 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            >
